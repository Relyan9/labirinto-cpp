    ...
    while (opcaoMenu != 5) {
        ...
        if (opcaoMenu == 1) {
            ...
            while (localAtual != 24 && vida > 0 && jogando) {
                ...
                if (vida > 0 && localAtual != 24 && jogando) {
                    movimentos++;
            ...
            cout << "2. Tente evitar perigos mortais, mas acho dificil, pois voce estara no escuro hahahaha...\n";
            cout << "3. A cada jogada existe umas chance de 30% de aconmtecer um evento aleatorio, onde voce ganha ou perde atributo.\n";
            ...
            cout << "Desenvolvedores: Helian, Andrey e Adriel.\n";
